...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Teaching",
          description: "A list of courses which I taught",
          section: "Navigation",
          handler: () => {
          ...
          title: "CV",
          description: "Further contact data or references on request",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-currently-i-am-looking-for-a-job-i-would-like-to-return-to-research-or-teaching-at-a-university-in-case-you-have-any-suggestions-please-contact-me-maybe-i-ll-find-something-before-the-summer-semester-26-starts",
          title: 'Currently, I am looking for a job: I would like to return to...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://arxiv.org/a/ulbrich_d_1.html", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=b1u5plUAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
